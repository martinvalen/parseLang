...
M.help.self = [[
NAME
  mad.lang.mad.grammar

SYNOPSIS
  local grammar = require"mad.lang.mad.grammar".grammar

DESCRIPTION
  Returns the regex-based grammar of MAD.
...
-- expressions
    ...
    valexp      <- literal / jsStyleFun / tabledef / fundef_a / lambda / varexp
...
M.test = require "mad.lang.mad.test.grammar"
--end]]
